...
export const applyToAnnouncement: AuthRequestHandler = async (req, res) => {
  try {
...
export const getAnnouncementApplications: AuthRequestHandler = async (req, res) => {
  try {
    const userId = req.user?.userId;
    const announcementId = req.params.id;
...
export const updateApplicationStatus: AuthRequestHandler<{ status: string }> = async (req, res) => {
  try {
    const userId = req.user?.userId;
