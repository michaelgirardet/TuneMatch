...
export default function ApplicationsPage() {
  ...
  return (
    <div className="flex-grow p-8 bg-oxford">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-quicksand font-bold mb-8 text-center text-white">
          Collabs reçues
        </h1>
        <div className="space-y-6">
          {applications.length === 0 ? (
            ...
            applications.map((application) => (
              <div key={application.id} className="bg-space rounded-lg p-6 space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {application.genres_musicaux && (
                      <p className="text-sm text-gray-400">Genres: {application.genres_musicaux}</p>
                    )}
                  </div>
                </div>
