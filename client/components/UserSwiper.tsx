...
export default function UserSwiper() {
  ...
  return (
    <div className="w-[90vw] md:w-[80vw] lg:w-[70vw] h-full bg-space rounded-2xl p-8 shadow-xl flex flex-col items-center justify-center self-center">
      <Image
        src={profile.photo_profil || '/default-avatar.jpg'}
        alt={profile.nom_utilisateur}
        width={140}
        height={140}
        className="avatar rounded-full object-cover mb-4"
        priority
      />
      ...
      <div className="flex gap-8">
        <button
          type="button"
          onClick={handlePass}
          className="btn bg-charcoal hover:bg-charcoalhover px-6 py-2 flex items-center gap-2 rounded-lg text-white font-semibold"
          aria-label="Passer"
        >
          <svg
        ...
        <button
          type="button"
          className="btn bg-red-500 hover:bg-red-400 px-6 py-2 flex items-center gap-2 rounded-lg text-white font-semibold"
          onClick={handleLike}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
